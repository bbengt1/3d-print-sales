...
- **Product Editor** — Full-page create/edit workflow at `/product-studio/products/new` and `/product-studio/products/:id/edit` with identity, SKU/UPC, internal UPC-A generation, pricing, material selection, reorder policy, margin preview, readiness context, and recent stock activity
