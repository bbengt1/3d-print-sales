...
- finance and workflow docs under `docs/` - feature-area technical references that should stay aligned with code changes, including Product Studio BOM behavior in [`../product_bom_tracking.md`](../product_bom_tracking.md) and reusable supply stock in [`../supply_inventory.md`](../supply_inventory.md)
